...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		// testando se o jogador esta se posicionado em check
	...
	// metodo para promove o peao a peca desejavel 
	...
	private Piece makeMove(Position source, Position target) { // logic to make the move
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// #specialmove en passant undomove
		...
		if (p instanceof Pawn) {
			if (source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnerable) {
				...
				// devolvedo a peão para ultima jogada
	...
	// testando se a peca esta em check
	...
	// testando sem a peca esta em CheckMate
